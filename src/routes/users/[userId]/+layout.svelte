...
<div class="grid gird-cols justify-center items-center">
	<div class="w-[375px] h-[812px]">
						...
						<ul class=" p-4 overflow-y-auto  w-[370px] h-[800px] text-base-content ">
							...
							<div class="grid grid-cols gap-2 ">
								...
								<div class="flex flex-col  text-[#5B7AA3] cursor-pointer">
									<button class="ml-4 mr-8 mt-24 text-start   text-[#5B7AA3] text-base ">
										LOGOUT</button
									>
		...
		h-[812px]  bg-[#5b7aa3]  shadow-none"
			>
				<!-- <div class="card w-[375px] h-[130px] shadow-none rounded-none border-none">
					<div class="card-body ">
				...
				<div class="card w-[375px] h-[130px] bg-[#5b7aa3] shadow-none rounded-none border-none">
					<div class="card-body">
						<div class=" flex flex-row h-16 w-16">
							<button on:click={onSidebarBtnClick}>
								<img src="/assets/home/svg/menu.svg" alt="" />
							</button>
							<img class="absolute right-0 " src="/assets/home/png/profile-settings.png" alt="" />
						</div>
			...
			h-[701px]  bg-base-100  rounded-none rounded-t-[44px] shadow-none "
				>
