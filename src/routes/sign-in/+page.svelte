	...
	>
		...
		<div class="card-body ">
			...
			<input
				...
				type="tel"
				name="phone"
				class=" h-[52px] w-[340px] max-[375px]:w-full py-2 px-3 border rounded-lg bg-[#fde2e4] mt-5 text-lg "
			/>
			<input name="loginRoleId" class="hidden" value="{loginRoleId}">

			<!-- <a href="/sign-in-otp"> -->
				<button
					class=" h-[52px] w-[340px] max-[375px]:w-full mt-8 mb-[180px] text-[#fff] text-xl font-bold rounded-lg bg-[#d05591] "
					>SEND OTP</button
				>
			<!-- </a> -->
		</form>
