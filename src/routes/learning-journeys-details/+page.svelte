...
<div class="flex items-center justify-center m-16">
	...
	>
		...
		h-[1150px]  bg-base-100  rounded-none rounded-t-[44px] shadow-sm  "
		>
			<div class="card-body  place-content-around  ">
				...
				<div class="flex mt-5">
					<img
						class="mb-2 "
						src="/assets/learning-journeys-details/svg/growing-up-affect.svg"
						alt=""
					/>
					<div class="ml-3 mt-5">
						<h3 class="text-left mb-2 ">How does growing up affect me?</h3>
						<div class="flex mr-4">
							<p>25 min</p>
							<div class="  opacity-50  border-0 ring-4 rounded-full h-[20px] w-[20px] ">
								<div class="rounded-full h-[20px]" style="width:50%" />
							</div>
						</div>
					</div>
				</div>
				<div class="flex">
					<img class="mb-2 " src="/assets/learning-journeys-details/svg/mind-changing.svg" alt="" />
					<div class="ml-3 mt-5">
						<h3 class="text-left mb-2 ">My body and mind is changing</h3>
						<div class="flex mr-4">
							<p>25 min</p>
							<div class="  bg-black opacity-10  rounded-full h-[20px] w-[20px] ">
								<div class="bg-[#70ae6e] rounded-full h-[20px]" style="width:50%" />
							</div>
						</div>
					</div>
				</div>
				<div class="flex ">
					<img
						class="mb-2 "
						src="/assets/learning-journeys-details/svg/accepting-body.svg"
						alt=""
					/>
					<div class="ml-3 mt-6">
						<h3 class="text-left mb-2 ">Accepting my body</h3>
						<div class="flex ">
							<p class="">25 min</p>
							<!-- <div class="  bg-black opacity-10  rounded-full h-[20px] w-[20px] ">
                                    <div class="bg-[#70ae6e] rounded-full h-[20px]" style="width:50%" />
				...
				<div class="flex mb-6">
					<img class="mb-2 " src="/assets/learning-journeys-details/svg/pressure.svg" alt="" />
					<div class="ml-3 mt-5">
						<h3 class="text-left mb-2 ">Dealing with Peer Pressure</h3>
						<div class="flex">
							<p>25 min</p>
							<div class="  bg-black opacity-10  rounded-full h-[20px] w-[20px] ">
								<div class="bg-[#70ae6e] rounded-full h-[20px]" style="width:50%" />
