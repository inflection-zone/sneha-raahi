...
<div class="flex items-center justify-center m-16">
	...
	>
		...
		<div class=" card-body h-[640px] bg-base-100">
			<h2 class="leading-4 text-lg mb-2">How does growing up affect me?</h2>
			<p class="h-[150px]">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nec lacus nec est
				condimentum consectetur quis eget nisi. Sed lacinia, felis sit amet faucibus vulputate, eros
				Leo viverra tellus, non faucibus diam neque a lectus. In et massa at tellus pellentesque
				mollis.
			</p>
			<div class="grid  grid-flow-col mb-3">
				...
				<div class="mx-2">
					<h3 class="text-left  mb-1">Module 01</h3>
					<p class="mb-3">Stages of growth</p>
			...
			<button class="text-center">
				<a href="/learning-home"> BACK TO COURSES </a>
			</button>
		</div>
	</div>
</div>
